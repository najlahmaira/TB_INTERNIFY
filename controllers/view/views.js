...
const pengajuanSuratTugas = async (req, res) => {
    ...
    res.render('sekjur/pengajuanSuratTugas', { id_kelompok: req.params.id, dataSelect: find })
}
...
const pengajuanSuratPengantar = async (req, res) => {
    ...
    res.render('sekjur/pengajuanSuratPengantar', { id_kelompok: req.params.id, dataSelect: find })
}
